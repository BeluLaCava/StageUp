            ...
            <asp:Panel ID="pnlFormularioEspacio" runat="server" Visible="false" DefaultButton="btnGuardarEspacio">
                ...
                <fieldset class="space-extra-fields" <%= FichaCompletaActiva ? "" : "disabled" %>>
                    ...
                    <section class="space-form-section">
                        <h3>01 · Galería de fotografías</h3>
                        <p>Elegí hasta ocho imágenes horizontales y bien iluminadas. La primera será la portada.</p>
                        <div class="space-photo-upload">
                            ...
                            <div>
                                <label for="<%= archivoFoto.ClientID %>">Agregar fotografías</label>
                                <asp:FileUpload ID="archivoFoto" runat="server" ClientIDMode="Static" AllowMultiple="true" accept="image/jpeg,image/png" />
                                <small>JPG o PNG, hasta 3 MB por imagen. Las fotografías actuales se conservan.</small>
                                <span id="photo-error" role="alert"></span>
                            </div>
                        </div>
                        <div id="photo-preview-list" class="space-photo-preview-list" aria-live="polite"></div>
                    </section>
                    <section class="space-form-section">
...
<asp:Content ID="MisEspaciosStyles" ContentPlaceHolderID="HeadContent" runat="server">
    <style>
        ...
        .space-photo-preview-list { display: grid; grid-template-columns: repeat(auto-fill, minmax(110px, 1fr)); gap: 10px; margin-top: 14px; }
        .space-photo-preview-list img { width: 100%; aspect-ratio: 4/3; object-fit: cover; border-radius: 10px; border: 1px solid var(--color-border); }
...
<asp:Content ID="MisEspaciosScripts" ContentPlaceHolderID="PageScripts" runat="server">
    <script src="<%= ResolveUrl("~/Scripts/espacios-ficha.js") %>?v=2"></script>
    <script>
        (function () {
